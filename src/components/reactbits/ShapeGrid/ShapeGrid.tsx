...
/**
 * ShapeGrid - animated, hover-reactive grid of shapes rendered on canvas.
 * Ported from React Bits (JS + Canvas) to TypeScript.
 */
const ShapeGrid = ({
  direction = "right",
  speed = 1,
  ...
  return (
    <canvas ref={canvasRef} className={`shapegrid-canvas ${className}`}></canvas>
  );
};
